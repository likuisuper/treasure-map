...
package com.cxylk.coverage.common;
...
public abstract class StringUtils {
    ...
    public static String format(String str, Map<String, String> args) {
        return str;
    }

    public static String getStringForExpr(String expr) {
    ...
    public static void main(String[] args) {
        getStringForExpr("adfadsf${vvv}adf,${ssa}");
    }
    ...
    public static String getErrorStackText(Throwable error) {
